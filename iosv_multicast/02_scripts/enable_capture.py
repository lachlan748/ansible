...
def run_commands(device_data):
    ...
    try:
        ...
        data = {}
        commands = ["monitor capture buffer test size 2048 max-size 9500 linear",
                    "monitor capture buffer test filter access-list filter",
                    "monitor capture point ip process-switched point0 both",
                    "monitor capture point ip cef point1 gig0/1 both",
                    "monitor capture point ip cef point2 gig0/2 both",
                    "monitor capture point ip cef point3 gig0/3 both",
                    "monitor capture point associate point0 test",
                    "monitor capture point associate point1 test",
                    "monitor capture point associate point2 test",
                    "monitor capture point associate point3 test",
                    "monitor capture point start point0",
                    "monitor capture point start point1",
                    "monitor capture point start point2",
                    "monitor capture point start point3",
                   ]
